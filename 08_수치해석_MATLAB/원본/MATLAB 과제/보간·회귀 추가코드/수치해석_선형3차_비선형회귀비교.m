...
% 결과 출력
fprintf('1st order에서 a1 %.4f , a0 %.4f\n\n', a1(1), a1(2));
fprintf('1차 다항식 수식: y = %.4fx + %.4f\n\n', a1(1), a1(2));

fprintf('3rd order에서 b3 %.4f , b2 %.4f , b1 %.4f , b0 %.4f\n\n', a3(1), a3(2), a3(3), a3(4));
fprintf('3차 다항식 수식: y = %.4fx^3 + %.4fx^2 + %.4fx + %.4f\n\n', a3(1), a3(2), a3(3), a3(4));

fprintf('비선형 회귀 결과: a = %.4f, b = %.4f\n\n', a, b);
fprintf('비선형 회귀 수식: y = %.4f * x * exp(%.4fx)\n\n', a, b);
...
% 결과 출력
fprintf('1st order 회귀: Sr = %.4f, r^2 = %.4f, Syx = %.4f\n\n', Sr1, r2_1, Syx1);
fprintf('3rd order 회귀: Sr = %.4f, r^2 = %.4f, Syx = %.4f\n\n', Sr3, r2_3, Syx3);
fprintf('비선형 회귀: Sr = %.4f, r^2 = %.4f, Syx = %.4f\n\n', Sr_nl, r2_nl, Syx_nl);
