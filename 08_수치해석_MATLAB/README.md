...
![오차 수렴 (log-log)](assets/convergence.png)

- 해석해 `y(t) = exp(t³/3 − 1.1t)`, `y(1) ≈ 0.4646`
- t=1에서 절대오차 `|y_num − y_exact|`:

| 방법 | h=0.5 | 0.25 | 0.125 | 0.0625 |
|---|---|---|---|---|
| 오일러(1차) | 2.06e-1 | 9.85e-2 | 4.88e-2 | 2.44e-2 |
| 중점(2차) | 2.73e-2 | 5.82e-3 | 1.35e-3 | 3.25e-4 |
| RK4(4차) | 3.52e-5 | 4.84e-6 | 4.63e-7 | 3.31e-8 |

→ 관측 수렴 차수 ≈ **오일러 1 · 중점 2 · RK4 4** 로 이론 차수와 일치. 같은 스텝(h=0.5)에서 RK4가 오일러보다 약 **6,000배** 정확(3.5e-5 vs 2.1e-1).
...
│                 └─ 선형 / 3차 / 비선형 회귀
│
├─ 근 찾기 ──────── 이분법 / False Position
│                 └─ Newton-Raphson / Wegstein
│
└─ 최적화 ───────── 황금분할(goldmin)
                  └─ 포물선 보간(ParabolicOpt)
```
